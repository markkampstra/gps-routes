...
module Web
  class Application < Hanami::Application
    configure do
      ...
      # security.content_security_policy "script-src 'self' https://maps.googleapis.com https://maps.gstatic.com; object-src 'self'"
      security.content_security_policy "script-src 'unsafe-inline' https://maps.googleapis.com https://maps.gstatic.com; object-src 'self'"
